...
## useEffect Tutorial
### The useEffect hook helps control component re-renders using a dependency array. Only items that change in the dependency array cause the useEffect hook to run. A cleanup function can also be used within the useEffect hook. Code highlights are described below.
<div>
